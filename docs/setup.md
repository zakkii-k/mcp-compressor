...
| 品質順 | モデル | RAM目安 | 特徴 |
|:------:|--------|--------|------|
| 1 | `qwen2.5:7b` | ~4.5GB | 要約精度最高。余裕があればこれ |
| 2 | `qwen3:4b` | ~3GB | thinking mode を本プロキシが自動無効化。Qwen2.5:3b より高品質 |
| 2 | `gemma4:e4b` | ~3GB | Google製 Gemma4 の主力軽量モデル。gemma3:4b より高品質 |
| 4 | `qwen2.5:3b` | ~2GB | **デフォルト推奨**。安定・高速・シンプル |
| 5 | `gemma3:4b` | ~3GB | 旧世代だが安定。gemma4:e4b が使えるなら不要 |
| 6 | `gemma4:e2b` | ~1.5GB | Gemma4 の最小版。RAM を節約したい場合のみ |
